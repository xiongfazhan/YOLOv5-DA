...
def get_filename_as_int(filename):
    try:
        ...
        if filename[:5] == "India":
            return int("2" + filename[6:])
        elif filename[:5] == "Japan":
            return int("3" + filename[6:])
        else:
            return int("1" + filename[6:])
...
if __name__ == "__main__":
    ...
    xml_path = 'E:/wider_face/COCO/xml_annotations/val'  # 这是xml文件所在的地址
    json_file = 'E:/wider_face/COCO/annotations/val.json'  # 这是你要生成的json文件
