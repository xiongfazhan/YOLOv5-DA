...
rootdir = "E:/wider_face"
gtfile = "E:/wider_face/wider_face_split/wider_face_val_bbx_gt.txt"
im_folder = "E:/wider_face/WIDER_val/images"
fwrite = open("E:/wider_face/wider_voc/ImageSets/Main/val.txt", "w")
...
with open(gtfile, "r") as gt:
    while (True):
        ...
        if numbox == 0:  # numbox 为0 的情况处理
            ...
            xmlpath = "{}/wider_voc/Annotations/{}.xml".format(rootdir, filename.split(".")[0])
